...
${partvtk} -dirdata ${diroutdata} -savevtk ${dirout2}/PartCube -onlytype:-all,+floating
if [ $? -ne 0 ] ; then fail; fi
...
${floatinginfo} -dirdata ${diroutdata} -onlymk:61 -savedata ${dirout2}/FloatingMotionCube1 
if [ $? -ne 0 ] ; then fail; fi

${floatinginfo} -dirdata ${diroutdata} -onlymk:62 -savedata ${dirout2}/FloatingMotionCube2 
if [ $? -ne 0 ] ; then fail; fi

${floatinginfo} -dirdata ${diroutdata} -onlymk:63 -savedata ${dirout2}/FloatingMotionCube3 
if [ $? -ne 0 ] ; then fail; fi
