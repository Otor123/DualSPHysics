...
Usage examples:
  python plotDifferenzPaperTemepratur.py --ana Test.csv

  python plotDifferenzPaperTemepratur.py --ana T_x_comparison_tableV2.csv

  python plotDifferenzPaperTemepratur.py --ana T_x_comparison_tableV2_dp_lower.csv


  python plotDifferenzPaperTemepratur.py --ana T_x_comparison_tableV2_dp_lowerlower.csv

  python diff_sim_analytic.py --sim Temp_over_Points0.csv --ana analytic.csv

  python plotDifferenzPaperTemepratur.py --ana T_x_comparison_tableV2_dp_0.0001.csv

  python plotDifferenzPaperTemepratur.py --ana T_x_comparison_tableV2_dp_0.0001.csv
  python plotDifferenzPaperTemepratur.py --ana T_x_comparison_tableV2_dp_0.00005.csv
  python plotDifferenzPaperTemepratur.py --ana T_x_comparison_tableV2_dp_0.000025.csv
  python plotDifferenzPaperTemepratur.py --ana T_x_comparison_tableV2_dp_0.0000125.csv
...
def main() -> None:
    ...
    ap.add_argument("--out_csv", type=str, default=f"sim_minus_analytic_diff_dp_{dp}.csv", help="Output CSV (semicolon-separated)")
    ap.add_argument("--out_png", type=str, default=f"sim_minus_analytic_diff_dp_{dp}.png", help="Output plot PNG")
    args = ap.parse_args()
