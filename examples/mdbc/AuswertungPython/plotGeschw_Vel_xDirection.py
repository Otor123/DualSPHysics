...
#2D:
#CSV_FILE = "/nishome/PaulS/Programms/DualSPHysicsImplementation/DualSPHysics/examples/mdbc/02_Poiseuille/CasePoiseuille_NS_LR_mDBC_out/measuretool/_PointsVelocity_Vel.x.csv"

PARTS = [100, 200, 300, 400, 500]                          # gewünschter Part
