...
# CSV-Datei einlesen
# --------------------------------------------------------
CSV_FILE = "/nishome/PaulS/Programms/DualSPHysicsImplementation/DualSPHysics/examples/mdbc/02_3_FreeCadPosieulle_X/Poisuelle/Poisuelle_mDBC_out/measuretool/_PointsVelocity_Vel.z.csv"   # <-- anpassen falls nötig



PARTS = [10, 200, 300, 400, 500]                          # gewünschter Part
...
plt.title("Vel.z über X für mehrere Parts")
plt.grid(True)
plt.legend()
plt.tight_layout()
plt.show()
