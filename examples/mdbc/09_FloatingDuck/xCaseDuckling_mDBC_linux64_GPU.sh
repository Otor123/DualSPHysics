...
${boundaryvtk} -loadvtk AutoActual -motiondata ${diroutdata} -savevtk ${dirout2}/ftduck -onlytype:-all,floating
if [ $? -ne 0 ] ; then fail; fi
...
${isosurface} -dirdata ${diroutdata} -saveiso ${dirout2}/Surface -iso_limits:0.03:0.03:0.02:0.47:0.47:0.5
if [ $? -ne 0 ] ; then fail; fi
