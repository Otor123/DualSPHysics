...
set name=CaseRollingTankHanging
...
%partvtk% -dirdata %diroutdata% -savevtk %dirout2%/PartTank -onlymk:10
if not "%ERRORLEVEL%" == "0" goto fail

%partvtk% -dirdata %diroutdata% -savevtk %dirout2%/PartStructure -onlymk:11
if not "%ERRORLEVEL%" == "0" goto fail
