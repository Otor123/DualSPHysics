...
set name=CaseDambreak2D_FSI_mDBC
...
%partvtk% -dirdata %diroutdata% -savevtk %dirout2%/PartGate -onlymk:12
if not "%ERRORLEVEL%" == "0" goto fail

%partvtk% -dirdata %diroutdata% -savevtk %dirout2%/PartStructure -onlymk:13
if not "%ERRORLEVEL%" == "0" goto fail
