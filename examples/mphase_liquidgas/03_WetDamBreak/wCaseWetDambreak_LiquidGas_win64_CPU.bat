...
set name=CaseWetDambreak_LiquidGas
...
mkdir %dirout2%
%partvtk% -dirin %dirout% -savevtk %dirout2%/PartWater -onlytype:-all,+fluid -onlymk:1
if not "%ERRORLEVEL%" == "0" goto fail

%partvtk% -dirin %dirout% -savevtk %dirout2%/PartAir -onlytype:-all,+fluid -onlymk:2
if not "%ERRORLEVEL%" == "0" goto fail

%partvtk% -dirin %dirout% -savevtk %dirout2%/PartGate -onlytype:-all,moving
if not "%ERRORLEVEL%" == "0" goto fail
