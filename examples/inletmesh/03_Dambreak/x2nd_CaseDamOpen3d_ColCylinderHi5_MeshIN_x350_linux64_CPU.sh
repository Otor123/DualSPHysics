...
export name=CaseDamOpen3d_ColCylinderHi5_MeshIN_x350
...
if [ ! -e CaseDamOpen2d_MakeData_out/GaugesMesh_Data-x350.mbi4 ]; then goto fail; fi
...
${isosurface} -dirdata ${diroutdata} -saveiso ${dirout2}/Surface -vars:-all,vel,idp -iso_limits:3.55:-1:-1:7:1:3
if [ $? -ne 0 ] ; then fail; fi
