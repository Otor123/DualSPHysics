...
${partvtk} -dirdata ${diroutdata} -saveenergy ${dirout}/_EnergyLeft -onlypos:-1:-1:0:1.1:2:1 -saveenergy ${dirout}/_EnergyRight -onlypos:1.1:-1:0:2.2:2:1
if [ $? -ne 0 ] ; then fail; fi
