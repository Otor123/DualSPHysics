...
${measuretool} -dirin ${diroutdata} -points PointsTemp.txt -onlytype:-all,+fluid -vars:-all,+vel.z,+vel.m,+temp -savevtk ${dirout2}/PointsTemp -savecsv ${dirout2}/_PointsTemp
