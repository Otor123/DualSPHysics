...
export dirout=${name}_out_longest_200_sec
...
export dirout2=${dirout}/measuretoolConvergenz
${measuretool} -dirin ${diroutdata} -points PointsTempConvergenz.txt -onlytype:-all,+fluid -vars:-all,+vel.z,+vel.m,+temp -savevtk ${dirout2}/PointsTempConvergenz -savecsv ${dirout2}/_PointsTempConvergenz
