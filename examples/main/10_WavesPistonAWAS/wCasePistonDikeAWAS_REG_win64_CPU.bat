...
%computeforces% -dirdata %diroutdata% -onlymk:12 -onlypos:8.5:-1:0:9:1:1 -savecsv %dirout2%/_DikeForce -savevtk %dirout2%/DikeForce 
if not "%ERRORLEVEL%" == "0" goto fail
...
%flowtool% -dirdata %diroutdata% -fileboxes CasePistonDike_FileBoxes.txt -savecsv %dirout2%/_ResultBoxes.csv -savevtk %dirout2%/Boxes.vtk
if not "%ERRORLEVEL%" == "0" goto fail
