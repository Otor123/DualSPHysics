...
${partvtk} -dirdata ${diroutdata} -savevtk ${dirout2}/PartFluid -onlytype:-all,+fluid -vars:+enkin
if [ $? -ne 0 ] ; then fail; fi
...
${computeforces} -dirdata ${diroutdata} -onlymk:11 -savecsv ${dirout2}/_WalNLorce -savevtk ${dirout2}/WalNLorce 
if [ $? -ne 0 ] ; then fail; fi
