...
%measuretool% -dirdata %diroutdata% -points elevation.txt -onlytype:-all,+fluid -elevation:0.4 -savecsv %dirout2%/Elevation
if not "%ERRORLEVEL%" == "0" goto fail
%measuretool% -dirdata %diroutdata% -points velocity.txt -onlytype:-all,+fluid -vars:-all,+vel -kclimit:0.4 -savecsv %dirout2%/Velocity 
if not "%ERRORLEVEL%" == "0" goto fail
