/*
 <DUALSPHYSICS-LiquidGas>  Copyright (c) 2018, 
 Dr Athanasios Mokos, Dr Jose M. Dominguez, Dr Benedict Rogers, Prof. Peter Stansby, 
 Dr Alejandro Crespo, Prof. Moncho Gomez Gesteira, Orlando Garcia-Feal,
 Dr Georgios Fourtakas, Dr Renato Vacondio, Dr Ricardo Canelas, Dr Stephen Longshaw, Dr Corrado Altomare.
...
\version LiquidGas 1.010 (DualSPHysics v4.0.048)
\date 04-06-2018
...
typedef struct StrAppInfo{
  ...
  bool ModeMK65k;
  StrAppInfo(){
    MainName="DualSPHysics4"; MainVer="v4.0.048";
    SubName="LiquidGas"; SubVer="v1.010";
    Date="02-03-2020";
#ifdef CODE_SIZE4
    ModeMK65k=true;
#else
...
std::string getlicense_lgpl(const std::string &name,bool simple){
  ...
  tx=tx+"\n Dr Athanasios Mokos, Dr Jose M. Dominguez, Dr Benedict Rogers,";
  tx=tx+"\n Prof. Peter Stansby, Dr Alejandro Crespo, Prof. Moncho Gomez Gesteira,";
  tx=tx+"\n Orlando Garcia-Feal, Dr Georgios Fourtakas,";
