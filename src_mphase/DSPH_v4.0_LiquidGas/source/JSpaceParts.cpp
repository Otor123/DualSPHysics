...
//==============================================================================
unsigned JSpaceParts::Count(TpParticlesNew type)const{
  unsigned n=0;
...
//==============================================================================
unsigned JSpaceParts::CountBlocks(TpParticlesNew type)const{
  unsigned n=0;
...
//==============================================================================
std::string JSpaceParts::GetMkList(TpParticlesNew type)const{
  string list;
...
JSpaceParts::StSummaryData JSpaceParts::GetSummaryData()const{
  ...
  TpParticlesNew types[ntp]={TpPartFixed,TpPartMoving,TpPartFloating,TpPartFluid};
  StSummaryData dat;
  unsigned idbegin=0;
