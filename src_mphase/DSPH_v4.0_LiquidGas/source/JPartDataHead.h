...
public:
  ...
  TpParticlesNew Type;   ///<Type of particle.
  ...
  JPartDataHeadMkBlock(TpParticlesNew type,unsigned mk,unsigned mktype,unsigned begin,unsigned count)
...
public:
  ...
  void ConfigParticles(TpParticlesNew type,unsigned mk,unsigned mktype,unsigned begin,unsigned count);
