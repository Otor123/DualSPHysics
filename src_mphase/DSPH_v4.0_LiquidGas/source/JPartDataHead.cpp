...
//==============================================================================
void JPartDataHead::ConfigParticles(TpParticlesNew type,unsigned mk,unsigned mktype,unsigned begin,unsigned count){
...
void JPartDataHead::LoadFile(std::string dir){
  ...
  for(unsigned c=0;c<nmk;c++){
    ...
    const TpParticlesNew type=TpPartGetType(item->GetvText("Type"));
